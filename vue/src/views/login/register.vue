<template>
	<div class="login-container">
		...
		<div class="login-box animate__animated animate__fadeIn">
			<div class="title">
                <h2>基于Yolov8+Deepseek的智能肺炎诊断系统</h2>
				<p>Pneumonia Diagnosis System Based on Yolov8+DeepSeek</p>
			</div>
...
.login-container {
	...
	background: linear-gradient(135deg, #E5DFFF 0%, #9E87FF 100%);
	padding: 20px;
}
...
.login-btn {
	...
	letter-spacing: 1px;
	border-radius: 8px;
	background: linear-gradient(to right, #E5DFFF 0%, #9E87FF 100%);
	border: none;
	margin-top: 10px;
